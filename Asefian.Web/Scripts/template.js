var alertTemplate =
    ...
    '            <button id="alert-ok-button" class="uk-button uk-button-primary btn-site" type="button">باشه</button>' +
    '        </p>' +
    '   </div>' +
    '</div>';
...
var confirmTemplate =
    ...
    '        <p class="uk-text-left uk-modal-footer">' +
    '            <button id="confirm-ok-button" class="uk-button uk-button-primary btn-site" type="button">بله</button>' +
...
function warnNotif(message) {
    UIkit.notification({ message: message, status: 'warning', pos: 'bottom-center' });
}

function dangerNotif(message) {
    UIkit.notification({ message: message, status: 'danger', pos: 'bottom-center' });
}