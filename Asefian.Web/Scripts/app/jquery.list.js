(function ($) {
    ...
    $.fn.list = function (options) {
        ...
        baseOptions.boxLoader = $(this).attr("loader-box") || null;
        ...
        else if (settings.loader === 2) boxLoader(settings.boxLoader ? settings.boxLoader : element, true);
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                else if (settings.loader === 2) boxLoader(settings.boxLoader ? settings.boxLoader : element, false);
